...
async def analyze_session_endpoint(
    ...
    total_duration_seconds: int = Form(15)
):
    ...
    for sec in range(1, total_duration_seconds + 1):
        ...
        # Create typed instance to stay compliant with SonarQube code validation rules
        metric_item = TimelineMetrics(
            second=sec,
            eye_gaze=eye_gaze,
        ...
        timeline_report.append(metric_item)
    ...
    return {
        ...
        "feedback": {
            ...
            "areas_for_improvement": f"{verbal_feedback} Focus on practicing posture stability between seconds 6 and 11."
        },
        "chronological_behavior_timeline": [item.model_dump() for item in timeline_report]
    }